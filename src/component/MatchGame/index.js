...
class MatchGame extends Component {
  ...
  componentDidMount() {
    this.timerInterval = setInterval(this.onStatusChange, 1000)
  }
  ...
  onImageClick = thumbnailUrl => {
    ...
    const imgUrl = imageValue[0].imageUrl
  ...
  render() {
    ...
    return (
      <div className="app-container">
        ...
        <ul className="render-section">
          {isTimerRunning ? (
            <li>
              <div className="container">
                <img src={activeImageUrl} alt="match" className="match-img" />
